        ...
        <div class="q-pa-xs col-xs-12 col-sm-6 col-sm-4">
          <q-card flat bordered>
            ...
            <q-card-section class="flex flex-center">
              ...
              <div v-else-if="props.row.title == 'NEXT ACTION'">
                <q-select
                  color="primary"
                  bg-color="gray"
                  filled
                ...
                <br />
                <q-btn class="absolute-center q-mt-md" color="primary"> ATTACK</q-btn>
                <br />
              </div>
              <div v-else>
...
for (const key in ch_data) {
  if (ch_data.hasOwnProperty(key)) {
    if (key == "characterClass") {
      ...
      rows.push({ title: key.toLocaleUpperCase(), data: proficiencies_array });
    } else {
